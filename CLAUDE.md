...
- **턴 / 챕터**: 턴 4 / 챕터 2 (고대 던전)
- **파티**:
  - 사이키 (마법사, HP 15/15, MP 26/30) — 마법 지팡이·마나 포션·마나 결정·슬라임 젤리·약초
  - 루체나 (도적, HP 22/22, MP 8/10) — 단검x2·도둑 도구·밧줄
  - 노을 (전사, HP 32/32, MP 5/5) — 오크의 도끼·가죽 방패
- **진행 상황**:
  - 어두운 오크 처치 (턴 3), 마법사 슬라임 처치 (턴 4) — 던전 2구역 전멸
  - 고대 비문 [7,8] 미해독 / 안전한 방 [8,8] 미사용 / 덩굴 함정 [5,3] 해제됨
  - 보물 상자 [16,12] 잠김 — 고대 열쇠 or 골렘 처치 필요
- **다음 목표**: 고대 비문 해독(INT DC14) → 보물실 진입
